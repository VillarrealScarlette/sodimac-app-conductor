...
import EventInRoute2List from "./EventInRoute2List";
...
class EventInRoute2Dashboard extends Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <Grid>
        <Grid.Column width={14}>
          <EventInRoute2List events={events} />
        </Grid.Column>
      </Grid>
    );
  }
...
export default EventInRoute2Dashboard;
